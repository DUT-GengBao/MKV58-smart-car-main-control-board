...
#define FTM0_CH1    PTE25        //PTC2、PTA4  PTE25 PTD1
#define FTM0_CH2    PTC3        //PTC3、PTA5  PTE29 PTD2 PTC5
#define FTM0_CH3    PTA6        //PTC4、PTA6  PTE30 PTD3
...
//      模块通道    端口          可选范围
#define FTM2_CH0    PTA10       //PTA10、PTB18 PTE22
#define FTM2_CH1    PTA11      //PTA11、PTB19 PTE23
...
#define FTM2_QDPHA  PTE22       //PTA10、PTB18 PTE22 PTA1
#define FTM2_QDPHB  PTE23       //PTA11、PTB19 PTE23 PTA2
 extern s16 counterVal;
/**********************************  FTM(引脚复用) ***************************************/
typedef enum
{
    Mot0,
