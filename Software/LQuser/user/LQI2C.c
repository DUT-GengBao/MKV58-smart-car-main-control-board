...
//      PORTE_PCR19 = PORTE_PCR19|(1<<5);//设置为开漏模式
//    }
//    else if(I2C0_SCL == PTE24)
//    {
//      PORTE_PCR24 = PORT_PCR_MUX(5);
//      PORTE_PCR24 = PORTE_PCR24|(1<<5);//设置为开漏模式
//    }
...
//      PORTC_PCR6 = PORTC_PCR6|(1<<5);//设置为开漏模式
//    }
//    else if(I2C0_SCL == PTC14)
//    {
//      PORTC_PCR14 = PORT_PCR_MUX(3);
//      PORTC_PCR14 = PORTC_PCR14|(1<<5);//设置为开漏模式
//    }
//    else if(I2C0_SCL == PTD2)
//    {
//      PORTD_PCR2 = PORT_PCR_MUX(7);
//      PORTD_PCR2 = PORTD_PCR2|(1<<5);//设置为开漏模式
//    }
//    
//    
//    if(I2C0_SDA == PTB1)
...
//      PORTE_PCR18 = PORTE_PCR18|(1<<5);//设置为开漏模式
//    } 
//    else if(I2C0_SDA == PTE25)
//    {
//      PORTE_PCR25 = PORT_PCR_MUX(5);
//      PORTE_PCR25 = PORTE_PCR25|(1<<5);//设置为开漏模式
//    } 
...
//      PORTC_PCR7 = PORTC_PCR7|(1<<5);//设置为开漏模式
//    }
//    else if (I2C0_SDA == PTC15)
//    {
//      PORTC_PCR15 = PORT_PCR_MUX(3);
//      PORTC_PCR15 = PORTC_PCR15 | (1<<5);//设置为开漏模式
//    }
//    else if (I2C0_SDA == PTD3)
//    {
//      PORTD_PCR3 = PORT_PCR_MUX(7);
//      PORTD_PCR3 = PORTD_PCR3 | (1<<5);//设置为开漏模式
//    }
//  }
//  else
//  {
...
//      PORTA_PCR14 = PORTA_PCR14|(1<<5);//设置为开漏模式
//    }
//    
//    if(I2C1_SDA == PTE0)
//    { 
...
//      PORTA_PCR13 = PORTC_PCR13 | (1<<5);//设置为开漏模式
//    } 
//  }
//  
//  /* 设置频率 */
//  I2C_F_REG(I2Cx[i2cn])  = I2C_F_MULT(2) | I2C_F_ICR(0x17) ; 
//  // MULT=00  即  mul = 1
