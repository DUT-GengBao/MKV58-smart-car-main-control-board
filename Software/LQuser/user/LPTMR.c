...
【实例】
QQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQQ*/
//void Test_LPTMR_delay(void)
//{
//  s16 counterVal;
//  char txt[16];   
//
//  LCD_CLS();           //LCD清屏  
//  LCD_P8x16Str(13,0,(uint8_t*)"LQ LPTMR dly");
//  
//  while (1)
//  {        
//    LPTMR_delay_ms(200);
//    sprintf(txt,"QAB2: %05dms \n",++counterVal*200);
...
//  LCD_CLS();           //LCD清屏  
//  LCD_P8x16Str(13,0,(uint8_t*)"LQ LPTMR dly");
//  LPTMR_Pulse_Init(LPT0_ALT2, 10000, LPT_Rising);//LPT0_ALT2  PTC5作为输入管脚
//  while (1)
//  {        
//    counterVal =LPTMR_Pulse_Get();     //获取编码器脉冲  
//    LPTMR_Pulse_Clean();
//    sprintf(txt,"LPTMR: %05d \n",counterVal);
//    LCD_P8x16Str(2,5,(uint8_t*)txt);
//    UART_Put_Str(UART_4,(uint8*)txt); //PTE24 口输出 
//    //LED闪烁
//    LED_Ctrl(LED1, RVS);    
//    for(tm=0;tm<275000000;tm++);         
//  }
//}
